...
void kill_screen(const char* lcd_msg) {
  ...
  void lcd_main_menu() {
    START_MENU();
    MENU_BACK(MSG_WATCH);
	#ifndef MSG_LOWER_BED
		#define MSG_LOWER_BED "Lower Bed"
	#endif
    MENU_ITEM(function, MSG_LOWER_BED, lcd_lowerbed);
    //
  ...
  void lcd_control_motion_menu() {
    ...
    MENU_BACK(MSG_CONTROL);
	  ...
	  #ifndef MSG_REHOME_Z
	    #define MSG_REHOME_Z "Re-home Z"
	  #endif
      MENU_ITEM(function, MSG_REHOME_Z, lcd_rehome_z);
    #endif
    // Manual bed leveling, Bed Z:
    #if ENABLED(MANUAL_BED_LEVELING)
      MENU_ITEM_EDIT(float43, MSG_BED_Z, &mbl.z_offset, -1, 1);
